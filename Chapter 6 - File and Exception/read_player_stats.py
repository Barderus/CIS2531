...
def main():
    ...
    try:
        ...
        print("Total number of players read from file =", num_players)
        print("Average games played =", format(total_games/num_players, ".2f"))  
        print("Overall batting average =", format(total_battling/num_players, ".2f"))
        print()            
