...
Created by Gabriel dos Reis
Includes the following functions:
    -> position_turtle(x_coord, y_coord)
...
def draw_right_triangle(color, length):
    ...
    Description:
    Draw color filled right-angled isosceles triangle
    with two equal length sides at current location.
    Uses Pythagorean theorem to calculate length of the 3rd side.
    '''
    turtle.fillcolor(color)
    turtle.begin_fill()
    turtle.forward(length)
